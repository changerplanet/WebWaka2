...
export const MATTER_TEMPLATES: MatterTemplate[] = [
  // CIVIL LITIGATION
  {
    ...
    defaultDocuments: [
      { title: 'Evidence of Debt', category: 'evidence', description: 'Contracts, invoices, receipts', required: true },
      { title: 'Demand Letter', category: 'correspondence', description: 'Formal demand for payment', required: true },
      { title: 'Writ of Summons', category: 'court_process', description: 'Originating court process', required: true },
      { title: 'Statement of Claim', category: 'pleading', description: 'Details of claim against defendant', required: true },
    ],
...

  {
    ...
    defaultDocuments: [
      { title: 'Contract Agreement', category: 'evidence', description: 'Original contract document', required: true },
      { title: 'Correspondence', category: 'evidence', description: 'Emails, letters between parties', required: true },
      { title: 'Damages Schedule', category: 'evidence', description: 'Itemized list of losses', required: true },
    ],
  ...
  // CRIMINAL DEFENSE
  {
    ...
    defaultDocuments: [
      { title: 'Charge Sheet', category: 'court_process', description: 'Criminal charges against client', required: true },
      { title: 'Bail Application', category: 'motion', description: 'Application for bail', required: true },
      { title: 'Client Statement', category: 'evidence', description: 'Client\'s written account', required: true },
      { title: 'Witness Statements', category: 'evidence', description: 'Defense witness statements', required: false },
    ],
...

  {
    ...
    defaultDocuments: [
      { title: 'Charge Sheet', category: 'court_process', description: 'EFCC/ICPC charges', required: true },
      { title: 'Bank Statements', category: 'evidence', description: 'Client financial records', required: true },
      { title: 'Forensic Report', category: 'evidence', description: 'Expert accountant analysis', required: false },
      { title: 'Asset Declaration', category: 'evidence', description: 'Client asset disclosure', required: true },
    ],
  ...
  // FAMILY LAW
  {
    ...
    defaultDocuments: [
      { title: 'Marriage Certificate', category: 'evidence', description: 'Original or certified copy', required: true },
      { title: 'Petition for Divorce', category: 'pleading', description: 'Divorce application', required: true },
      { title: 'Financial Statement', category: 'evidence', description: 'Assets and liabilities', required: true },
      { title: 'Children Birth Certificates', category: 'evidence', description: 'If children involved', required: false },
    ],
...

  {
    ...
    defaultDocuments: [
      { title: 'Custody Application', category: 'motion', description: 'Formal application to court', required: true },
      { title: 'Affidavit of Welfare', category: 'evidence', description: "Child's best interest statement", required: true },
      { title: 'Birth Certificate', category: 'evidence', description: 'Child birth documentation', required: true },
    ],
  ...
  // PROPERTY LAW
  {
    ...
    defaultDocuments: [
      { title: 'Certificate of Occupancy (C of O)', category: 'evidence', description: 'State land title', required: false },
      { title: 'Survey Plan', category: 'evidence', description: 'Registered survey document', required: true },
      { title: 'Deed of Assignment', category: 'evidence', description: 'Transfer documents', required: false },
      { title: 'Receipt/Purchase Agreement', category: 'evidence', description: 'Evidence of purchase', required: true },
      { title: 'Photographs of Property', category: 'evidence', description: 'Current state of land', required: true },
    ],
...

  {
    ...
    defaultDocuments: [
      { title: 'Tenancy Agreement', category: 'evidence', description: 'Original lease document', required: true },
      { title: 'Notice to Quit', category: 'correspondence', description: 'Quit notice to tenant', required: true },
      { title: "Owner's Intention Notice", category: 'correspondence', description: '7 days recovery notice', required: true },
      { title: 'Rent Receipt/Payment History', category: 'evidence', description: 'Payment records', required: true },
    ],
  ...
  // EMPLOYMENT LAW
  {
    ...
    defaultDocuments: [
      { title: 'Employment Contract', category: 'evidence', description: 'Terms of employment', required: true },
      { title: 'Termination Letter', category: 'evidence', description: 'Dismissal notice', required: true },
      { title: 'Pay Slips', category: 'evidence', description: 'Salary documentation', required: true },
      { title: 'Staff Handbook', category: 'evidence', description: 'Company policies', required: false },
      { title: 'Query/Warning Letters', category: 'evidence', description: 'Disciplinary correspondence', required: false },
    ],
  ...
  // CORPORATE/COMMERCIAL
  {
    ...
    defaultDocuments: [
      { title: 'Memorandum & Articles', category: 'evidence', description: 'Company constitution', required: true },
      { title: 'Shareholder Agreement', category: 'evidence', description: 'If any exists', required: false },
      { title: 'Board Resolutions', category: 'evidence', description: 'Relevant board minutes', required: true },
      { title: 'Share Certificates', category: 'evidence', description: 'Proof of shareholding', required: true },
      { title: 'CAC Forms', category: 'evidence', description: 'Annual returns, Form CAC7', required: true },
    ],
  ...
  // BANKING & FINANCE
  {
    ...
    defaultDocuments: [
      { title: 'Offer Letter', category: 'evidence', description: 'Loan facility offer', required: true },
      { title: 'Loan Agreement', category: 'evidence', description: 'Facility agreement', required: true },
      { title: 'Deed of Legal Mortgage', category: 'evidence', description: 'Security document', required: false },
      { title: 'Guarantee', category: 'evidence', description: 'Personal/corporate guarantee', required: false },
      { title: 'Account Statement', category: 'evidence', description: 'Loan account history', required: true },
    ],
  ...
  // INTELLECTUAL PROPERTY
  {
    ...
    defaultDocuments: [
      { title: 'Trademark Representation', category: 'evidence', description: 'Logo/mark image', required: true },
      { title: 'TM-1 Application Form', category: 'court_process', description: 'Registration application', required: true },
      { title: 'Power of Attorney', category: 'evidence', description: 'Agent authorization', required: true },
      { title: 'Certificate of Incorporation', category: 'evidence', description: 'For corporate applicants', required: false },
    ],
  ...
  // TAX
  {
    ...
    defaultDocuments: [
      { title: 'Assessment Notice', category: 'evidence', description: 'FIRS assessment', required: true },
      { title: 'Tax Returns', category: 'evidence', description: 'Filed tax returns', required: true },
      { title: 'Financial Statements', category: 'evidence', description: 'Audited accounts', required: true },
      { title: 'Objection Letter', category: 'correspondence', description: 'Formal objection', required: true },
      { title: 'Notice of Appeal', category: 'court_process', description: 'TAT appeal', required: true },
    ],
