  ...
  static async createZone(tenantId: string, input: CreateZoneInput) {
    ...
    return prisma.logisticsDeliveryZone.create({
      data: {
        ...
        polygon: input.polygon as Prisma.InputJsonValue,
  ...
  static async updateZone(tenantId: string, zoneId: string, input: UpdateZoneInput) {
    return prisma.logisticsDeliveryZone.update({
      ...
      data: {
        ...
        ...(input.polygon !== undefined && { polygon: input.polygon as Prisma.InputJsonValue }),
  ...
  static async updatePricingRule(
    ...
    return prisma.logisticsDeliveryPricingRule.update({
      ...
      data: {
        ...
        ...(input.tiers !== undefined && { tiers: input.tiers as Prisma.InputJsonValue }),
