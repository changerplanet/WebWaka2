  ...
  static async updateZone(tenantId: string, zoneId: string, input: UpdateZoneInput) {
    return prisma.logistics_delivery_zones.update({
      ...
      data: {
        ...
        ...(input.polygon !== undefined && { polygon: input.polygon as object | undefined }),
  ...
  static async createPricingRule(tenantId: string, input: CreatePricingRuleInput) {
    ...
    return prisma.logisticsDeliveryPricingRule.create({
      data: {
        ...
        minFee: input.minFee,
        maxFee: input.maxFee,
        tiers: input.tiers as object | undefined,
  ...
  static async updatePricingRule(
    ...
    return prisma.logisticsDeliveryPricingRule.update({
      ...
      data: {
        ...
        ...(input.tiers !== undefined && { tiers: input.tiers as object | undefined }),
