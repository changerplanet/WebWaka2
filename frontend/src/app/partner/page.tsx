        ...
        <div className="grid grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
            <div className="flex items-center justify-between mb-6">
              ...
              <a href="/partner/earnings" className="text-sm text-green-400 hover:text-green-300 flex items-center gap-1">
                ...
                return (
                  <div key={i} className="flex-1 flex flex-col items-center gap-2">
                    <div className="w-full flex flex-col items-center">
                      ...
                      <div 
                        className="w-full bg-green-500/30 rounded-t-lg transition-all hover:bg-green-500/50"
          ...
          <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
            <div className="flex items-center justify-between mb-6">
              ...
              <a href="/partner/referrals" className="text-sm text-green-400 hover:text-green-300 flex items-center gap-1">
                View All <ChevronRight className="w-4 h-4" />
              </a>
            </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
            <div className="flex items-center justify-between mb-6">
              ...
              <a href="/partner/referrals?sort=revenue" className="text-sm text-green-400 hover:text-green-300 flex items-center gap-1">
              ...
              <div className="space-y-3">
                {dashboard.referrals.topPerformers.slice(0, 5).map((tenant, i) => (
                  <div key={tenant.referralId} className="flex items-center gap-4 p-3 rounded-xl hover:bg-slate-700/50 transition">
                    <div className="w-8 h-8 rounded-lg bg-green-500/20 text-green-400 flex items-center justify-center text-sm font-bold">
                      {i + 1}
                    </div>
                    <div className="flex-1 min-w-0">
          ...
          <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
            <div className="flex items-center justify-between mb-6">
              ...
              <a href="/partner/audit" className="text-sm text-green-400 hover:text-green-300 flex items-center gap-1">
                ...
                {dashboard.recentActivity.slice(0, 5).map((activity) => (
                  <div key={activity.id} className="flex items-start gap-4 p-3 rounded-xl hover:bg-slate-700/50 transition">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                      ...
                      activity.type === 'REFERRAL' ? 'bg-green-500/20 text-green-400' :
                      activity.type === 'PAYOUT' ? 'bg-green-500/20 text-green-400' :
