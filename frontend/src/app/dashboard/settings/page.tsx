...
export default function SettingsPage() {
  ...
  const [activeTab, setActiveTab] = useState<'general' | 'members' | 'domains' | 'branding' | 'instances'>('general')
  ...
  async function fetchData() {
    try {
      ...
      // Fetch active capabilities for instances
  ...
  const tabs = [
    ...
    { id: 'instances', label: 'Platform Instances', icon: Layers },
  ]
