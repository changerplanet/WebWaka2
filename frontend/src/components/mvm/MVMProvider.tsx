...
// ============================================================================
// SEED DATA (Development/Testing Only - Not used in production)
// These constants are only used when API returns empty data during development.
// In production, all data comes from the database via API.
// ============================================================================

const SEED_VENDOR: Vendor = {
  id: 'seed-vendor-1',
...
const DEMO_PRODUCT_MAPPINGS: ProductMapping[] = [
  { id: 'map-1', vendorId: 'seed-vendor-1', productId: 'prod-5', productName: 'Wireless Headphones', productSku: 'HP-WLS-BLK', price: 199.99, isActive: true, salesCount: 45, revenue: 8999.55, createdAt: '2025-06-20T00:00:00Z' },
  { id: 'map-2', vendorId: 'seed-vendor-1', productId: 'prod-8', productName: 'Fitness Watch', productSku: 'FW-GPS-BLK', price: 149.99, isActive: true, salesCount: 38, revenue: 5699.62, createdAt: '2025-06-20T00:00:00Z' },
  { id: 'map-3', vendorId: 'seed-vendor-1', productId: 'prod-4', productName: 'Leather Wallet', productSku: 'WLT-LTH-BRN', price: 49.99, isActive: true, salesCount: 28, revenue: 1399.72, createdAt: '2025-07-15T00:00:00Z' },
  { id: 'map-4', vendorId: 'seed-vendor-1', productId: 'prod-7', productName: 'Sunglasses', productSku: 'SG-AVT-GLD', price: 79.99, isActive: false, salesCount: 12, revenue: 959.88, createdAt: '2025-08-01T00:00:00Z' },
]

const DEMO_COMMISSIONS: Commission[] = [
  { id: 'comm-1', subOrderId: 'so-001', vendorId: 'seed-vendor-1', saleAmount: 199.99, commissionRate: 15, commissionAmount: 30.00, vendorPayout: 169.99, status: 'PENDING', calculatedAt: '2026-01-02T06:30:00Z' },
  { id: 'comm-2', subOrderId: 'so-002', vendorId: 'seed-vendor-1', saleAmount: 299.98, commissionRate: 15, commissionAmount: 45.00, vendorPayout: 254.98, status: 'PENDING', calculatedAt: '2026-01-01T18:45:00Z' },
  { id: 'comm-3', subOrderId: 'so-003', vendorId: 'seed-vendor-1', saleAmount: 249.98, commissionRate: 15, commissionAmount: 37.50, vendorPayout: 212.48, status: 'PROCESSING', calculatedAt: '2025-12-31T14:20:00Z' },
  { id: 'comm-4', subOrderId: 'so-004', vendorId: 'seed-vendor-1', saleAmount: 149.99, commissionRate: 15, commissionAmount: 22.50, vendorPayout: 127.49, status: 'PAID', calculatedAt: '2025-12-30T09:15:00Z' },
]
...
export function MVMProvider({ children, tenantId, initialVendorId }: MVMProviderProps) {
  // Require explicit tenant ID - no hardcoded defaults
  if (!tenantId) {
    throw new Error('MVMProvider requires a tenantId. No tenant context available.')
  }
  
  const [vendorId, setVendorIdState] = useState<string | null>(initialVendorId || null)
