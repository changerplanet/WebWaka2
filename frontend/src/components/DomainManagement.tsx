    ...
    <div className="space-y-6">
                ...
                <div className="mt-4 p-4 bg-amber-50 rounded-lg">
                  ...
                  <div className="bg-white rounded-lg p-3 font-mono text-sm space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-slate-900">_webwaka-verify</span>
                    </div>
                    <div className="flex justify-between items-center">
      ...
      <div className="bg-slate-50 rounded-xl p-6">
        ...
        <div className="text-sm text-slate-600 space-y-2">
          <p><strong>Subdomain:</strong> Your default address at {tenantSlug}.webwaka.com</p>
          <p><strong>Custom Domain:</strong> Use your own domain like app.yourdomain.com</p>
          <p><strong>DNS Setup:</strong> Add a CNAME record pointing to cname.webwaka.com</p>
        </div>
      </div>
    </div>
  )
