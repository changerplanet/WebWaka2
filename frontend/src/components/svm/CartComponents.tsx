        ...
        {cart.items.length > 0 && (
          <div className="border-t border-slate-200 p-6 space-y-4">
                ...
                <div className="flex gap-2">
                  <div className="flex-1 relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 border border-slate-200 rounded-lg focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none text-sm"
            ...
            <button
              ...
              className="w-full py-4 bg-green-600 hover:bg-green-700 text-white rounded-xl font-semibold text-lg transition-colors flex items-center justify-center gap-2"
