  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <h3 
          className="font-medium text-slate-900 mb-2 line-clamp-2 cursor-pointer hover:text-green-600 transition-colors"
          onClick={() => onSelect(product)}
        >
          {product.name}
        </h3>
...
export function ProductGrid({ onSelectProduct }: ProductGridProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto" data-testid="product-grid">
      ...
      <div className="flex flex-col lg:flex-row gap-4 mb-8">
        ...
        <form onSubmit={handleSearch} className="flex-1">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none transition-all"
        ...
        <div className="flex items-center gap-3">
          <select
            ...
            className="px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-green-500 outline-none"
          ...
          <div className="flex bg-white border border-slate-200 rounded-xl overflow-hidden">
            <button
              ...
              className={`p-3 ${viewMode === 'grid' ? 'bg-green-50 text-green-600' : 'text-slate-400 hover:text-slate-600'}`}
            >
              <Grid className="w-5 h-5" />
            </button>
            <button
              onClick={() => setViewMode('list')}
              className={`p-3 ${viewMode === 'list' ? 'bg-green-50 text-green-600' : 'text-slate-400 hover:text-slate-600'}`}
            >
      ...
      <div className="mb-8 p-4 bg-gradient-to-r from-green-50 to-amber-50 rounded-xl flex items-center gap-3">
  ...
  return (
    <div className="max-w-6xl mx-auto" data-testid="product-detail">
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        {/* Details */}
        <div>
          <p className="text-green-600 font-medium mb-2">{product.categoryName}</p>
          ...
          <div className="flex gap-4 mb-8">
            <button
              ...
              className="flex-1 py-4 bg-green-600 hover:bg-green-700 text-white rounded-xl font-semibold text-lg transition-colors flex items-center justify-center gap-3"
