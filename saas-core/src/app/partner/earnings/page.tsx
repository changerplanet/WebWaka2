      ...
      <main className="ml-64 p-8">
        ...
        <div className="grid grid-cols-4 gap-6 mb-8">
          <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl p-6">
            ...
            <p className="text-indigo-200 mt-1">Available for Payout</p>
          </div>
                  ...
                  <div key={i} className="flex-1 flex flex-col items-center gap-1">
                    <div className="w-full flex flex-col items-center h-48 justify-end gap-0.5">
                      ...
                      <div className="w-full flex gap-0.5 items-end">
                        <div 
                          className="flex-1 bg-indigo-500/50 rounded-t transition-all hover:bg-indigo-500/70"
          ...
          <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
            ...
            <div className="space-y-6">
              {[
                ...
                { label: 'Cleared', amount: balanceData.cleared, color: 'bg-indigo-500', desc: 'Ready to be approved' },
                { label: 'Approved', amount: balanceData.approved, color: 'bg-emerald-500', desc: 'Waiting for payout batch' },
                { label: 'In Payout Batch', amount: balanceData.inBatch, color: 'bg-purple-500', desc: 'Processing' },
              ].map((item, i) => {
          ...
          <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
            ...
            <div className="grid grid-cols-5 gap-6">
              <div className="text-center p-4 bg-slate-700/30 rounded-xl">
                <p className="text-3xl font-bold text-indigo-400">{performance.conversionRate.toFixed(1)}%</p>
              ...
              <div className="text-center p-4 bg-slate-700/30 rounded-xl">
                <p className="text-3xl font-bold text-purple-400">{formatCurrency(performance.averageRevenuePerReferral)}</p>
