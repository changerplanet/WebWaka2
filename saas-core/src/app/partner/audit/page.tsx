...
export default function AuditPage() {
  ...
  const getActionColor = (action: string) => {
    ...
    if (action.includes('PAID') || action.includes('APPROVED')) return 'bg-indigo-500/20 text-indigo-400 border-indigo-500/30'
    if (action.includes('LOCKED')) return 'bg-purple-500/20 text-purple-400 border-purple-500/30'
          ...
          <div className="flex items-center gap-3">
            <div className="flex bg-slate-800 rounded-xl p-1 border border-slate-700">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm transition ${
                  viewMode === 'report' ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:text-white'
                }`}
              >
                Report
              </button>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-5 gap-4 mb-8">
              ...
              <div className="bg-slate-800 rounded-xl p-4 border border-slate-700">
                <p className="text-2xl font-bold text-indigo-400">{report.summary.earningsPaid}</p>
                <p className="text-sm text-slate-400">Earnings Paid</p>
              </div>
              <div className="bg-slate-800 rounded-xl p-4 border border-slate-700">
                <p className="text-2xl font-bold text-purple-400">{report.summary.payoutBatches}</p>
