      ...
      <div className="flex items-center justify-between">
        ...
        {!isEditing ? (
          <button
            ...
            className="px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-medium transition-colors"
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-300 text-white rounded-xl font-medium flex items-center gap-2 transition-colors"
              ...
              <div>
                ...
                {isEditing ? (
                  <input
                    ...
                    className="w-full px-4 py-2.5 border border-slate-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none"
              ...
              <div>
                ...
                {isEditing ? (
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-2.5 border border-slate-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none resize-none"
