          ...
          <div className="p-6">
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                disabled={!productId}
                className="flex-1 py-2.5 bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-300 text-white rounded-xl font-medium"
              >
                Add Product
              </button>
            </div>
    ...
    <div className="space-y-6" data-testid="vendor-products">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-medium flex items-center gap-2 transition-colors"
